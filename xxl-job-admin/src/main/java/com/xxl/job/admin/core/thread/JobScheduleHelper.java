...
//            Date nextValidTime = new CronExpression(jobInfo.getScheduleConf()).getNextValidTimeAfterFromEveryDay(fromTime);
            Date nextValidTime = new MultiCronExpression(jobInfo.getScheduleConf(), "\\|").getNextValidTimeAfter(fromTime);
