...
create index IDX_XXL_JOB_REGISTRY_TIME on XXL_JOB_REGISTRY(UPDATE_TIME) ;
...
VALUES (XXL_JOB_INFO_ID.nextval, 1, '测试任务1', to_date('2018-11-03 22:21:31','yyyy-MM-dd HH24:mi:ss'), to_date('2018-11-03 22:21:31','yyyy-MM-dd HH24:mi:ss'), 'XXL', '', 'CRON', '0 0 0 * * ? *', 'DO_NOTHING', 'FIRST', 'demoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', to_date('2018-11-03 22:21:31','yyyy-MM-dd HH24:mi:ss'), '');
