				...
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="schedule_conf schedule_conf_FIX_RATE" style="display: none" >
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control" name="schedule_conf_FIX_RATE" placeholder="${I18n.system_please_input} （ Second ）" maxlength="100"  ></div>
<#--                            onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"-->
                        ...
                        <div class="schedule_conf schedule_conf_FIX_DELAY" style="display: none" >
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control" name="schedule_conf_FIX_DELAY" placeholder="${I18n.system_please_input} （ Second ）" maxlength="100" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" ></div>
                        </div>
                    </div>
